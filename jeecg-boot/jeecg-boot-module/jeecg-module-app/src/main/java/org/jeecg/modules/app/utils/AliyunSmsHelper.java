...
import org.jeecg.modules.app.bean.enums.AliyunSmsEnum;
...
public class AliyunSmsHelper {
    ...
    private final static Logger logger = LoggerFactory.getLogger(AliyunSmsHelper.class);
    ...
    public static void setAccessKeyId(String accessKeyId) {
        AliyunSmsHelper.accessKeyId = accessKeyId;
    }

    public static void setAccessKeySecret(String accessKeySecret) {
        AliyunSmsHelper.accessKeySecret = accessKeySecret;
    }
    ...
    public static boolean sendSms(String phone, JSONObject templateParamJson, AliyunSmsEnum dySmsEnum) throws ClientException {
        //可自助调整超时时间
    ...
    private static void validateParam(JSONObject templateParamJson, AliyunSmsEnum dySmsEnum) {
    ...
    public static boolean sendSms(String phone, JSONObject templateJson) {
        try {
            ...
            com.aliyun.dypnsapi20170525.models.SendSmsVerifyCodeRequest sendSmsVerifyCodeRequest = new com.aliyun.dypnsapi20170525.models.SendSmsVerifyCodeRequest()
                    ...
                    .setTemplateParam(JSON.toJSONString(templateJson));
    ...
    public static com.aliyun.dypnsapi20170525.Client createClient() throws Exception {
        ...
        config.setAccessKeyId(staticConfig.getAccessKeyId());
        config.setAccessKeySecret(staticConfig.getAccessKeySecret());
    ...
    public static void main(String[] args) throws Exception {
        ...
        obj.put("code", "888888");
        obj.put("min", 5);
        boolean result = sendSms("13650962253", obj);
